        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              ...
              <Input type="number" placeholder="30" {...register('vidaUtilDias', { valueAsNumber: true })} />
            </div>
          </div>
          ...
          <div className="flex items-center justify-between rounded-lg border p-3 dark:border-gray-700">
            ...
            <Switch checked={requiereFrio} onCheckedChange={(v) => setValue('requiereCadenaFrio', v)} />
          </div>
          ...
          {requiereFrio && (
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2">
                ...
                <Input type="number" step="0.1" placeholder="0" {...register('temperaturaMinima', { valueAsNumber: true })} />
              </div>
              <div className="space-y-2">
                <Label className="dark:text-gray-300">Temp. Máxima (°C)</Label>
                <Input type="number" step="0.1" placeholder="4" {...register('temperaturaMaxima', { valueAsNumber: true })} />
              </div>
            </div>
          )}
